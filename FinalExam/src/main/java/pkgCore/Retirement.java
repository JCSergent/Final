...
public class Retirement {
	...
	public double MonthlySavings() {
		...
		double pmt = Math.abs(PMT(dAnnualReturnWorking/1200,iYearsToWork*12,0,this.TotalAmountToSave(),false)); // <-- this should be fixed to calculate the real pmt
	...
	public double TotalAmountToSave() {
		...
		double pv = Math.abs(PV(dAnnualReturnRetired/1200, iYearsRetired*12,dRequiredIncome-dMonthlySSI,0,false));
